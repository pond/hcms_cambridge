...
#
# Lazy-created when a customer goes to pay for an event or encounter booking,
# but no Stripe price has been created yet; an API call sets up the price in
# Stripe, then its ID is recorded herein for subsequent purchases.
#
# Stripe prices and related products are managed thereafter by the Event or
# Encounter models, since those are well placed to know about deletion,
